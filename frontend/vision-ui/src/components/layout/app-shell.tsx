...
const navItems = [
  { to: "/dashboard", num: "00", label: "Dashboard" },
        ...
        <header className="sticky top-0 z-30 bg-paper/85 backdrop-blur-md border-b border-rule">
          <div className="flex items-center justify-between px-6 lg:px-12 h-14">
            ...
            <div className="flex items-center gap-1.5">
              ...
              <Link href="/account" className="ml-2 h-8 w-8 rounded-full bg-ink text-paper grid place-items-center font-display text-sm">AR</Link>
            </div>
          </div>
