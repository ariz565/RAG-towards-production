...
export default function Dashboard() {
  ...
  useEffect(() => {
    setTime(new Date().toLocaleString("en-US", { weekday: "long", month: "long", day: "numeric" }));
  }, []);
    ...
    >
      ...
      <div className="grid grid-cols-12 gap-8">
        ...
        <section className="col-span-12 lg:col-span-8">
          <div className="flex items-baseline justify-between mb-6">
            ...
            <Link href="/documents" className="text-xs font-mono uppercase tracking-widest text-ink-soft hover:text-ink ink-link">View all →</Link>
          </div>
      ...
      <section className="mt-20 grid grid-cols-12 gap-6">
        <div className="col-span-12 lg:col-span-7 bg-ink text-paper p-10 lg:p-14 rounded-lg grain relative overflow-hidden">
          ...
          <Link href="/chat" className="mt-8 inline-flex items-center gap-3 text-paper font-mono text-xs uppercase tracking-widest border-b border-paper/40 pb-1 hover:border-cobalt-300 hover:text-cobalt-300 relative">
        ...
        <div className="col-span-12 lg:col-span-5 paper-card rounded-lg p-10 flex flex-col">
          ...
          <Link href="/documents" className="mt-auto pt-8 inline-flex items-center gap-2 text-ink font-mono text-xs uppercase tracking-widest ink-link self-start">
            Upload document →
          </Link>
        </div>
      </section>
